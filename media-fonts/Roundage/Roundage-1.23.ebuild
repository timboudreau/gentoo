...
FONT_CONF=( "${FILESDIR}/63-roundage.conf" )
...
src_install() {
	...
	doins "${S}/${PN}/${PN}-Condensed-Regular.ttf"
	doins "${S}/${PN}/${PN}-Condensed-RegularItalic.ttf"
	doins "${S}/${PN}/${PN}-Condensed-Bold.ttf"
	doins "${S}/${PN}/${PN}-Condensed-BoldItalic.ttf"
	doins "${S}/${PN}/${PN}-Condensed-Thin.ttf"
	doins "${S}/${PN}/${PN}-Condensed-ThinItalic.ttf"
	doins "${S}/${PN}/${PN}-Condensed-Black.ttf"
	doins "${S}/${PN}/${PN}-Condensed-BlackItalic.ttf"
	doins "${S}/${PN}/${PN}-Condensed-VeryLight.ttf"
	doins "${S}/${PN}/${PN}-Condensed-VeryLightItalic.ttf"
