...
src_compile() {
    ...
    ronn -m ${WORKDIR}/etcd-${PV}/Documentation/docs.md > ${T}/etcd.1
    ronn -m ${WORKDIR}/etcd-${PV}/Documentation/faq.md > ${T}/etcd.2
    ronn -m ${WORKDIR}/etcd-${PV}/Documentation/tuning.md > ${T}/etcd.3
    ronn -m ${WORKDIR}/etcd-${PV}/Documentation/metrics.md > ${T}/etcd.4
    eend ${?}
}
